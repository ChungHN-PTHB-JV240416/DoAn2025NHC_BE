...
import ra.doantotnghiep2025nhc.model.dto.MostLikedProductDTO;
import ra.doantotnghiep2025nhc.model.dto.ProductReponseDTO;
import ra.doantotnghiep2025nhc.model.entity.Products;
import ra.doantotnghiep2025nhc.repository.BrandRepository;
import ra.doantotnghiep2025nhc.repository.CategoryRepository;
import ra.doantotnghiep2025nhc.repository.ProductRepository;
import ra.doantotnghiep2025nhc.service.ProductService;
...
public class ProductServiceImp implements ProductService {
    ...
    private ProductReponseDTO convertToDTO(Products product) {
        return ProductReponseDTO.builder()
                ...
                .createdAt(java.util.Date.from(product.getCreatedAt().atZone(ZoneId.systemDefault()).toInstant()))
                .updatedAt(product.getUpdatedAt() != null ? java.util.Date.from(product.getUpdatedAt().atZone(ZoneId.systemDefault()).toInstant()) : null)
                .build();
    }
}
