...
import ra.doantotnghiep2025nhc.model.entity.*;
import ra.doantotnghiep2025nhc.repository.AddressRepository;
import ra.doantotnghiep2025nhc.repository.PasswordResetTokenRepository;
import ra.doantotnghiep2025nhc.repository.RoleRepository;
import ra.doantotnghiep2025nhc.repository.UserRepository;
import ra.doantotnghiep2025nhc.security.UserPrinciple;
import ra.doantotnghiep2025nhc.security.jwt.JwtProvider;
import ra.doantotnghiep2025nhc.service.AuthService;
import ra.doantotnghiep2025nhc.service.EmailService;
import ra.doantotnghiep2025nhc.service.UploadFileService;
...
public class AuthServiceImp implements AuthService {
    private static final Logger log = Logger.getLogger(AuthServiceImp.class.getName());
    @Autowired
    ...
    @Override
    public UserLoginResponse login(UserLoginRequestDto userLoginRequestDTO) throws CustomerException {
        try {
            log.info("Thực hiện xác thực cho username: " + userLoginRequestDTO.getUsername());
            ...
            log.info("Đăng nhập thành công cho username: " + userPrinciple.getUsername());
            ...
            log.warning("Lỗi xác thực: " + e.getMessage());
            throw new CustomerException("Tên người dùng hoặc mật khẩu không đúng");
        }
    }
    @Override
    public UserRegisterResponseDTO register(UserRegisterRequestDTO userRegisterDTO) throws CustomerException {
        log.info("Đăng ký người dùng với username: " + userRegisterDTO.getUsername());
        ...
        log.info("Đăng ký thành công cho username: " + userNew.getUsername());
    ...
    @Override
    public UserResponseDTO addAddress(Long userId, UploadFileService.AddressRequestDTO addressRequestDTO) throws CustomerException {
